...
**iRacing** no es un videojuego en el sentido tradicional; es el ejemplo perfecto de lo que Manovich llamaría una **remezcla profunda**. Aquí, el software no intenta simplemente "representar" una carrera (como lo haría una película o una retransmisión televisiva), sino que *reconstruye* la física del mundo real mediante algoritmos complejos.
